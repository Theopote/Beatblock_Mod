...
public final class ChoreographyPlanCompiler {
	...
	public static int compileAnimationEvents(
		...
		return TimelineDraftWriter.writeAutoGeneratedEvents(timeline, draft, replace);
	}
	...
	public static SmartAutoMapCompileResult compileAll(
		...
		int animations = compileAnimationEvents(timeline, plan, config, replaceAnimations);
		int cameras = compileCameraEvents(timeline, plan);
		int vfx = compileVfxEvents(timeline, plan);

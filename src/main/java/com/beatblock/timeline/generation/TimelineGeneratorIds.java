...
/** 已知 Timeline 内容生成器标识（{@link TimelineGenerationMetadata#generatorId()}）。 */
public final class TimelineGeneratorIds {
	...
	public static final String AUDIO_ACCENT_GENERATOR = "audio-accent-generator";
	public static final String USER_MACRO = "user-macro";

	private TimelineGeneratorIds() {}
}

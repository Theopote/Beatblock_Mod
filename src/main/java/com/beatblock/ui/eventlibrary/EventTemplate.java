...
public record EventTemplate(
	...
	public static @NonNull EventTemplate fromAnimationEvent(
		...
		Map<String, Object> stored = TimelineGenerationMetadataSupport.sanitizeForTemplate(event);
		AnimationEventParams params = AnimationEventParams.fromParameterMap(stored);
